        ...
        >
          {cols.map((_, j) => (
            <motion.div
              ...
              key={`col` + j}
              className="relative h-8  w-16 border-r border-t border-zinc-900"
            >
              {j % 2 === 0 && i % 2 === 0 ? (
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="pointer-events-none absolute -left-[22px] -top-[14px] h-6 w-10 stroke-[1px] text-zinc-900"
                >
                  <path
                    strokeLinecap="round"
